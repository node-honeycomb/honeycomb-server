...
exports.ping = function (req, res) {
  ...
  // if cluster not setup, return data will be set to null
  // only true means cluster match
  return res.json({
    code: 'SUCCESS',
    data: cluster ? cluster === req.query.clusterCode : null
  });
};
...
exports.liveness = function (req, res) {
  message.send({
