 ...
 * @query {string} clusterCode
 */
exports.ping = function (req, res) {
  let ips = req.query.ips;
  let timeout = Number(req.query.timeout);
  ips = ips && ips.split(',');
  let path = '/api/single/ping?clusterCode=' + req.query.clusterCode;
  utils.callremote(path, {method: 'GET', ips: ips, timeout: timeout || 5000}, function (err, results) {
...
exports.setClusterInfo = function (req, res) {
  ...
  utils.callremote(path, {method: 'POST', ips: ips, data: req.body, timeout: timeout || 5000}, function (err, results) {
    res.json(resultsWrap(err, results));
  });
};
