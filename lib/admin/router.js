...
module.exports = function (router) {
  ...
  // 健康检查, liveness
  router.get('/api/health', ctrlSystemSingle.healthCheck);
  router.get('/api/liveness', ctrlSystemSingle.liveness);
  // 就绪检查, readiness
  router.get('/api/readiness', ctrlSystemSingle.healthCheck);
